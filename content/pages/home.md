  ...
  - body: ''
    ...
    projects:
      ...
      - abstract: Multiplayer Trading Card Game for the Web
        name: DRIMGAR
        summary: ''
        skills: React, API, Firebase, Node.js, Websockets, Github API, Stable
          Diffusion
        date: 09/2019
        backgroundImages:
      ...
      - abstract: Multiplayer billiards game for iOS and Android
        ...
        summary: >
          ...
          rotation.
        skills: Flash, Actionscript, Box2D,OpenGL, iOS, Android, Photoshop,
      ...
      - abstract: 3D visualization tool for online races
        ...
        summary: >
          ...
          online racing game
        skills: Typescript, React, MUI, Threejs, Recharts, Sentry, Jira, Node.js, AWS,
          Figma
        date: 09/2022
        thumbnailImages:
          - ../julia-joppien.jpg
      ...
      - abstract: Strategy browser game with trains on the blockchain
        ...
        skills: PixiJS, JavaScript, TypeScript, Blockchain, EOSIO, NFT, Firebase,
      ...
      - abstract: Multiplayer party games on the web.
        ...
        skills: Lerna, Typescript, React, Firebase, Firebase Firestore, Firebase
    ...
    _template: projects
  - quote: A good programmer is someone who always looks both ways before crossing a
      one-way street.
